            ...
            <form onSubmit={onSubmit}>
                <NoticeDiv>
                    <NoticeTitleDiv>
                        <StyeldLabel>
                            Title:
                            <StyledInput type="text" name="noticeTitle" value={notice.title} onChange={onChange} />
                        </StyeldLabel>
                    </NoticeTitleDiv>
                    <NoticeContentDiv>
                        <StyeldLabel>
                            작품 분류 : 
                            <StyledInput type="text" name="filmoType" value={notice.filmo_type} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            작품명 : 
                            <StyledInput type="text" name="filmoName" value={notice.filmo_name} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            역할명 : 
                            <StyledInput type="text" name="filmoRole" value={notice.filmo_role} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            지원 마감 일자 :
                            <StyledInput type="text" name="applyDeadlineDt" value={notice.apply_deadline_dt} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            촬영 시작(예정)일 :
                            <StyledInput type="text" name="filmingStartPeriod" value={notice.filming_start_period} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            촬영 종료(예정)일 :
                            <StyledInput type="text" name="filmingEndPeriod" value={notice.filming_end_period} onChange={onChange} />
                        </StyeldLabel>
                        <StyeldLabel>
                            상세 내용 :
                            <StyledTextArea name="noticeContent" value={notice.content} onChange={onChange} />
                        </StyeldLabel>
